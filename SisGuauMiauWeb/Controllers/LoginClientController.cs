...
using SisGuauMiauWeb.Models;


namespace SisGuauMiauWeb.Controllers
{
    ...
    public class LoginClientController : Controller
    {
        ...
        //
        private LoginRestfulClient loginRestful = new LoginRestfulClient();
        ...
        public ActionResult validarUsuario(String usuario, String password)
        {
            ...
            try {
                ...
                String res = loginRestful.usuarioValidacion(usuario, password).Result;

                //if (res == null)
                //{
                //    //return RedirectToAction("ViewPaginaPrincipal", "CntProductos");
                //    return Json("Error en el Servicio Consumido");
                //}
            ...
            catch (Exception ex)
            {
                ...
                return Json("Ocurrió un Error en el Service");
